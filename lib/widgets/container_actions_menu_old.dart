...
class _ContainerActionsMenuState extends State<ContainerActionsMenu>
  ...
  Widget build(BuildContext context) {
    ...
    // Wrap PopupMenuButton in a Builder to create a fresh context
    return Builder(
          ...
          itemBuilder: (popupContext) => [
            PopupMenuItem(
              child: ListTile(
                ...
                onTap: () => _buyCoffeeForContainer(popupContext),
              ),
            ),
            PopupMenuItem(
              child: ListTile(
                ...
                title: Text(l10n.sellOffline,
                    style: const TextStyle(color: Colors.black)),
                onTap: () =>
                    _sellContainerOffline(popupContext, widget.container),
              ),
            ),
              ...
              PopupMenuItem(
                child: ListTile(
                  ...
                  title: Text(l10n.sellOnline,
                      style: const TextStyle(color: Colors.black)),
                  onTap: () async {
                    Navigator.pop(popupContext, "close menu");
                    ...
                    if (outgoingItems.isNotEmpty) {
                      ...
                      await fshowInfoDialog(
                          builderContext, l10n.selectItemToSell);
                    }
            ...
            PopupMenuItem(
              child: ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(popupContext, "close menu");
                    showChangeContainerDialog(builderContext, widget.container);
                    widget.onRepaint();
                  }),
            ),
            PopupMenuItem(
              child: ListTile(
                ...
                onTap: () => _generateDDS(popupContext),
              ),
            ),
            PopupMenuItem(
              child: ListTile(
              ...
              PopupMenuItem(
                child: ListTile(
                  ...
                  title: Text(l10n.debugDeleteContainer,
                      style: const TextStyle(color: Colors.black)),
                  onTap: () => _deleteContainer(popupContext),
                ),
              ),
          ],
        );
